...
Command to run plugin as script:

    $> python3 ./plugin.py -v -l - 1ba63b34-b1bb-4014-8e99-01b14131f9ae --endpoint http://localhost:9091/gatekeeper --keystore http://localhost:9090/keystore 
